...
6. Victories progress the party through 3 → 5 → 8 → 10 → 12; battles contain two or three waves, and clearing the final wave fully restores the party and automatically distributes a generous loot bundle without blocking progression on a prompt.
