...
The `0.3.2-alpha.7` candidate adds party-sized, role-balanced enemy rosters and explicit collision/click blocking for solid scenery to the level-3, level-5, level-8, and level-10 fixtures; it retains native death saves, full between-round restoration, automatic abundant rewards and progression, current-tier save recovery, and the perimeter wall pass.
